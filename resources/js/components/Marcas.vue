    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <card-component titulo="Pesquisar">

                    <!-- slot para o conteúdo -->
                    <template v-slot:conteudo>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input-container-component id="inputID" titulo="ID"  idHelp="idHelp" textoAjuda="Opcional. Informe o ID da marca.">
                    ...
                    <template v-slot:rodape>
                        <button type="submit" class="btn btn-info float-right" @click="pesquisar()">Pesquisar</button>                        
                    ...
                    <template v-slot:rodape>
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <button type="button" class="btn btn-success float-right"  data-toggle="modal" data-target="#modalMarca">Adicionar</button>                        
                            </div>
                        </div>
        ...
        <modal-component id="modalMarcaAtualizar" titulo="Atualizar marca">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="Nome da marca" id="atualizarNome" idHelp="atualizarImagemHelp" textoAjuda="Informe o nome da marca.">
                        <input type="text" class="form-control" id="atualizarNome" aria-describedby="atualizarImagemHelp" placeholder="Nome da marca" v-model="$store.state.item.nome">
                    </input-container-component>
                </div>
                <div class="form-group">
            ...
            atualizar(){
                ...
                axios.post(url, formData, config)
                    .then(response => {
                        ...
                        this.$store.state.transacao.mensagem = 'Registro de marca atualizado'
                        this.carregarLista()
                    })
                    .catch(errors => {
